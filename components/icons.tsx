...
export const DocumentIcon: React.FC<IconProps> = ({ className = 'h-6 w-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const AtlassianIcon: React.FC<IconProps> = ({ className = 'h-8 w-8' }) => (
    <svg role="img" viewBox="0 0 24 24" className={className} xmlns="http://www.w3.org/2000/svg">
        <path d="M11.993 2.182a1.32 1.32 0 0 0-1.123.59L1.905 15.659a1.343 1.343 0 0 0 .01 1.486l.035.053c.48.655 1.34.88 2.115.59l7.92-3.045a1.33 1.33 0 0 1 1.25 0l7.92 3.045a1.34 1.34 0 0 0 2.115-.59l.035-.052a1.343 1.343 0 0 0 .01-1.487L13.12 2.772a1.32 1.32 0 0 0-1.127-.59zm-.008 3.55a1.33 1.33 0 0 0-1.128.59L3.9 15.548l7.96-3.063a1.33 1.33 0 0 1 1.25 0l7.96 3.063L13.12 6.32a1.33 1.33 0 0 0-1.135-.588z" fill="currentColor"/>
    </svg>
);
